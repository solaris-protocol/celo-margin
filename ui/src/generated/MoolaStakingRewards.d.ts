...
interface MoolaStakingRewardsInterface extends ethers.utils.Interface {
  functions: {
...
export type PeriodFinishUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & { originalFinish: BigNumber; newFinish: BigNumber }
>;
...
export class MoolaStakingRewards extends BaseContract {
  ...
  filters: {
    ...
    "PeriodFinishUpdated(uint256,uint256)"(
      ...
      [BigNumber, BigNumber],
      { originalFinish: BigNumber; newFinish: BigNumber }
    >;
