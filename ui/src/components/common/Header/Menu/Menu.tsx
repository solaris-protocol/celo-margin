...
import { BookOpen, Code, Info, MessageCircle, Send } from 'react-feather'
import { NavLink } from 'react-router-dom'
import styled from 'styled-components'

import { ReactComponent as MenuIcon } from '../../../../assets/images/_old/menu.svg'
...
export const Menu: FC = () => {
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          <MenuItemInternal id="link" to="/trade">
            <Send size={14} />
            Trade
          </MenuItemInternal>
