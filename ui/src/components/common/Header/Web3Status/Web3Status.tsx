...
import { useToggleWalletSelectModal, useWalletModalToggle } from '../../../../state/application/hooks'
import { isTransactionRecent, useAllTransactions } from '../../../../state/transactions/hooks'
import { TransactionDetails } from '../../../../state/transactions/reducer'
import { shortenAddress } from '../../../../utils'
import { ButtonSecondary } from '../../_old/Button'
import Identicon from '../../_old/Identicon'
import Loader from '../../_old/Loader'
import WalletModal from '../../_old/WalletModal'
...
function Web3StatusInner() {
  ...
  const toggleSelectWalletModal = useToggleWalletSelectModal()
  ...
  if (accountName) {
    ...
    return (
      <Web3StatusError onClick={toggleSelectWalletModal}>
        <NetworkIcon />
    ...
    return (
      <Web3StatusConnect id="connect-wallet" onClick={toggleSelectWalletModal} faded={!address}>
