...
import { CardNoise } from 'components/common/_old/earn/styled'
...
import Icon from '../../../../assets/_old/svg/icon-ube.svg'
import Logo from '../../../../assets/_old/svg/logo.svg'
import LogoDark from '../../../../assets/_old/svg/logo-dark.svg'
...
export default function Header() {
  ...
  return (
    <HeaderFrame>
      ...
      {/*</Modal>*/}
      <SideModalWallet isOpen={showUbeBalanceModal} onDismiss={() => setShowUbeBalanceModal(false)} />
      <HeaderRow>
        <Title to="/">
          <UbeIcon>
