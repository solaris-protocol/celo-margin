...
import { useCloseModals, useToggleWalletSelectModal } from 'state/application/hooks'
import styled, { ThemeContext } from 'styled-components'

import { ReactComponent as Close } from '../../../../assets/images/_old/x.svg'
